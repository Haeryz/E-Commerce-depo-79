    ...
    items.push(
      <TimelineItem key="waiting">
        ...
        <TimelineContent>
          ...
          <TimelineDescription>
            {formatDateTime(currentCheckout?.createdAt || "")}
          </TimelineDescription>
        </TimelineContent>
      </TimelineItem>
    );
      ...
      items.push(
        <TimelineItem key="rejected">
          ...
          <TimelineContent>
            ...
            <TimelineDescription>
              {formatDateTime(currentCheckout?.updatedAt || "")}
            </TimelineDescription>
      ...
      <DrawerRoot open={open} onOpenChange={(e) => setOpen(e.open)}>
        ...
        <DrawerTrigger asChild>
          <IconButton
            ...
            variant="ghost"
            position="absolute" // Position it absolutely within the DrawerRoot
            top={4} // Adjust the top distance from the top of the screen
            right={4} // Adjust the right distance from the right of the screen
          >
            <MdMenu />
          </IconButton>
        </DrawerTrigger>
            ...
            <VStack align="stretch" gap={4}>
              ...
              {!isAuthenticated ? (
                ...
                <>
                  ...
                  <Button
                    variant="ghost"
                    onClick={() => handleNavigation("/profile/profile-sidebar")}
                  >
                    Settings
                  </Button>
                  <Button
        ...
        <DialogContent p={10}>
          {!selectedOrderId ? (
            ...
            <VStack align="stretch" gap={4}>
              ...
              <TimelineRoot maxW="400px">{getTimelineItems()}</TimelineRoot>
            </VStack>
          )}
          <DialogCloseTrigger />
        </DialogContent>
